...
variable "nv_sdwan_bgp_asn" {
  description = "BGP ASN for nv-sdwan router (us-east-1)"
  type        = number
  default     = 65001
}

variable "fra_sdwan_bgp_asn" {
  description = "BGP ASN for fra-sdwan router (eu-central-1)"
  type        = number
  default     = 65003
}

variable "nv_branch1_bgp_asn" {
  description = "BGP ASN for nv-branch1 router (us-east-1)"
  type        = number
  default     = 65002
}

variable "fra_branch1_bgp_asn" {
  description = "BGP ASN for fra-branch1 router (eu-central-1)"
  type        = number
  default     = 65004
}
