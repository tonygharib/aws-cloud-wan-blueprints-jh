...
""".format(asn=SDWAN_BGP_ASN[router_name], peer_ip1=peer_ip1, cloudwan_asn=cloudwan_asn)
...
""".format(asn=SDWAN_BGP_ASN[router_name], peer_ip2=peer_ip2, cloudwan_asn=cloudwan_asn)
